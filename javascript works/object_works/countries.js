...
// console.log(countries[0].currencies[0]);
// let currencyName=countries[0].currencies[0].name
// console.log(countries[0].currencies[0].name);
...
if("currencies" in country)
  ...
  //console.log(`countryname${countryName} population ${population} capital ${capital}  currencies ${currencyName}`);
...
//myCountries.filter(data=>data.population>20000000)
//Map(cntry=>cntry.countryName)forEach(name=>console.log(name))
